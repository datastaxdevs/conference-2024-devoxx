...
public class BM25 {
     ...
     */
    public BM25(final List<String> corpus, final Language language) {
        this(corpus, 1.5, 0.75,
                StopWords.getStopWords(language),
                new StemmerSnowBall(language));
    }
     ...
     */
    public BM25(final List<String> corpus, final Language language, Set<String> stopWords) {
        this(corpus, 1.5, 0.75, stopWords, new StemmerSnowBall(language));
    }
    ...
    public BM25(final List<String> corpus,
        ...
        this(corpus,
            ...
            StopWords.getStopWords(Language.ENGLISH),
            new StemmerSnowBall(language));
    }
