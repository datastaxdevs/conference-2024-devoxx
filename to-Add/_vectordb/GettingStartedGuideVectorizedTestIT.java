...
public class GettingStartedGuideVectorizedTestIT extends TestSupport {
    ...
    public static void initStoreForTests() {
        astraDatabase = devoxx.rag._vectordb.AstraDBTestSupport.createDbIfNotExist(devoxx.rag._vectordb.AstraDBTestSupport.TEST_DB_vectorize);
    ...
    private static void ingestDocument(String docName, AstraDbEmbeddingStore store) {
        ...
        Document inputDocument = FileSystemDocumentLoader.loadDocument(
                new File(devoxx.rag._vectordb.AstraDBTestSupport.class.getResource("/" + docName)
                        .getFile())
                        .toPath(),
    ...
    public void should_search_with_content_retriever() {
        devoxx.rag._vectordb.Assistant ai = AiServices.builder(devoxx.rag._vectordb.Assistant.class)
                .contentRetriever(
